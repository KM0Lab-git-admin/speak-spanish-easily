  ...
  return (
    <div className={cn("relative", className)}>
      ...
      >
        ...
        <div className="relative flex items-end justify-between gap-0 vertical-tablet:gap-2">
          {modules.map((mod, idx) => (
...
const ModuleItem = ({ module, emphasized = false }: ModuleItemProps) => {
  ...
  return (
    <button
      ...
      aria-label={label}
      className={cn(
        "group relative flex flex-col items-center min-w-0 transition-transform cursor-pointer active:scale-95",
      ...
      <div className="relative flex flex-col items-center">
        ...
        <span
          className={cn(
            ...
            "px-[clamp(0.375rem,1.7vw,0.625rem)] py-0.5 rounded-full bg-white",
            "border border-km0-blue-300/60",
            "shadow-[0_2px_6px_-2px_hsl(var(--km0-blue-900)/0.25)]",
            "font-ui font-bold text-[clamp(8px,2.45vw,10px)] leading-tight text-km0-blue-800",
