...
const HomeModules = ({ modules, className }: HomeModulesProps) => {
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <div
        className={cn(
          "relative bg-km0-beige-100 horizontal-mobile:bg-transparent horizontal-desktop:bg-transparent",
          "rounded-t-3xl",
          ...
          "px-[clamp(4px,2vw,12px)] py-[20px] opacity-100 horizontal-mobile:!py-2 my-[20px] horizontal-mobile:!my-2",
        )}
      >
...
const ModuleItem = ({ module, emphasized = false }: ModuleItemProps) => {
  ...
  const sizeClasses = emphasized
    ? "w-[clamp(60px,17vw,78px)] h-[clamp(60px,17vw,78px)] vertical-tablet:w-[88px] vertical-tablet:h-[88px] horizontal-mobile:!w-[46px] horizontal-mobile:!h-[46px] horizontal-desktop:!w-[72px] horizontal-desktop:!h-[72px]"
    : "w-[clamp(54px,15vw,68px)] h-[clamp(54px,15vw,68px)] vertical-tablet:w-[78px] vertical-tablet:h-[78px] horizontal-mobile:!w-[44px] horizontal-mobile:!h-[44px] horizontal-desktop:!w-[70px] horizontal-desktop:!h-[70px]";
      ...
      <div className="relative flex flex-col items-center">
        ...
        <span
          className={cn(
            ...
            "font-ui font-bold text-[10px] vertical-mobile:text-[clamp(8px,2.45vw,10px)] leading-tight text-km0-blue-800 horizontal-mobile:!text-[9px] horizontal-desktop:!text-[12px]",
