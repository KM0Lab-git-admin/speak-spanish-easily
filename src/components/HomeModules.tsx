...
const ModuleItem = ({ module, emphasized = false }: ModuleItemProps) => {
  ...
  const sizeClasses = emphasized
    ? "w-[clamp(60px,17vw,78px)] h-[clamp(60px,17vw,78px)] vertical-tablet:w-[88px] vertical-tablet:h-[88px] horizontal-mobile:!w-[62px] horizontal-mobile:!h-[62px] horizontal-desktop:!w-[72px] horizontal-desktop:!h-[72px]"
    : "w-[clamp(54px,15vw,68px)] h-[clamp(54px,15vw,68px)] vertical-tablet:w-[78px] vertical-tablet:h-[78px] horizontal-mobile:!w-[60px] horizontal-mobile:!h-[60px] horizontal-desktop:!w-[70px] horizontal-desktop:!h-[70px]";
