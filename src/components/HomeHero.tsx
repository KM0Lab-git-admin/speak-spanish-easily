        ...
        <div className="flex items-center gap-2 min-w-0 vertical-tablet:gap-1.5 vertical-tablet:items-center">
          ...
          <div className="flex flex-row items-center gap-2 leading-none min-w-0 vertical-tablet:gap-1.5 vertical-tablet:items-center">
            ...
            <div className="flex items-center">
              <Km0Logo className="h-4 vertical-tablet:h-4 horizontal-mobile:!h-3 w-auto" />
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0 horizontal-mobile:gap-1.5 vertical-tablet:gap-1.5 vertical-tablet:items-center">
          {showLogin && (
            <LoginButton
              onClick={onLogin}
              size="md"
              className="inline-flex min-h-9 vertical-tablet:min-h-9 vertical-tablet:!px-3 vertical-tablet:!py-1 vertical-tablet:!text-xs horizontal-mobile:!text-[11px] horizontal-mobile:!px-2.5 horizontal-mobile:!py-1"
            />
          )}
          <NotificationBell
            hasAlerts={hasAlerts}
