...
const HomeHero = ({
  ...
  return (
    <motion.section
      className={
        inline
          ? "relative shrink-0 flex flex-col overflow-hidden bg-gradient-to-b from-km0-beige-50 to-km0-beige-100 pb-0 horizontal-mobile:h-[92px] horizontal-desktop:h-[78px] w-full"
