  ...
  return (
    ...
    >
      ...
      {(greetingSlot || showGreeting) && (
        <div className="relative z-10 px-3 mt-3 pb-3 vertical-tablet:mt-4 vertical-tablet:pb-4 horizontal-mobile:mt-2 horizontal-mobile:pb-2 horizontal-mobile:pointer-events-auto horizontal-desktop:pointer-events-auto bg-white/55 my-0">
