...
const BASE =
  "font-ui font-bold text-km0-blue-700 bg-km0-yellow-500 hover:bg-km0-yellow-400 active:scale-95 transition-all rounded-full whitespace-nowrap shadow-[0_4px_12px_-4px_hsl(var(--km0-blue-700)/0.3)]";

const SIZES: Record<NonNullable<LoginButtonProps["size"]>, string> = {
  sm: "text-xs px-3.5 py-1 vertical-tablet:text-sm vertical-tablet:px-5 vertical-tablet:py-1.5",
