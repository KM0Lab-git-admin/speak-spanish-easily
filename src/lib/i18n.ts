...
const D = {
  ...
  "merchant.points.done_title": {
    ca: "Ja has guanyat +{n} punts",
    es: "Ya has ganado +{n} puntos",
    en: "You already earned +{n} points",
  } as Dict,
  "merchant.points.done_subtitle": {
    ca: "Has escanejat el QR d'aquest comerç",
    es: "Has escaneado el QR de este comercio",
    en: "You've scanned this shop's QR",
  } as Dict,
